    ...
    plugins: [
        ...
        /** @satisfies {import('rollup').Plugin} */ ({
            ...
            renderChunk(code, chunk, options, meta) {
                //return code.replace(/^function commonjsRequire\(path\) {\n[\s\S]*?\n^}$/gm, `
        ...
        commonjs({
            dynamicRequireTargets: [
                'node_modules/.pnpm/sharp@*/node_modules/sharp/build/Release/sharp-*.node',
                'node_modules/.pnpm/sharp@*/node_modules/sharp/build/Release/*.dll',
                'node_modules/.pnpm/sharp@*/node_modules/sharp/build/Release/*.dylib',
                'node_modules/.pnpm/sharp@*/node_modules/sharp/build/Release/*.so',
                // 'node_modules/.pnpm/sharp@*/node_modules/sharp/build/Release/*/sharp-*.node',
                'node_modules/.pnpm/sharp@*/node_modules/sharp/vendor/**/versions.json',
            ]
        }),
        nodeResolve(),
        swc({
